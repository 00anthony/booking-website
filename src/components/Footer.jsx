            ...
            <footer className="bg-black text-white px-4 sm:px-6 pt-10" id='footer'>
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className='flex flex-col items-center text-center'>
                        ...
                        <div className="w-full max-w-[440px] aspect-w-16 aspect-h-9 rounded-lg shadow-md overflow-hidden">
                            <iframe
                    ...
                    {/* Social Media Links */}
                    <div className='flex justify-centerflex flex-col items-center text-center'>
                        <h2 className="text-xl mb-4">Follow Us</h2>
                        <ul className="space-y-2 flex justify-center">
                            <li>
                                <Link to="#" className="inline-flex justify-center items-center text-white hover:text-gray-500 text-xl transform hover:scale-110 transition-transform duration-200" aria-label="Twitter">
                            ...
                            <li className="ml-4">
                                <Link to="#" className="inline-flex justify-center items-center text-white hover:text-gray-500 text-xl transform hover:scale-110 transition-transform duration-200" aria-label="Facebook">
                                    <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
