...
import btnImg from '../images/faded-headquarters-logo.jpg';
    ...
    return (
        <>
            <div className="hero" id='hero'>
                ...
                <section className="relative z-10 h-screen flex flex-col items-center justify-start sm:justify-center pt-20 sm:pt-0 ">
                    <svg
                    ...
                    <div className="absolute md:mt-[-300px] pt-20 ">
                        <button className="group relative w-36 h-36 rounded-full bg-none shadow-lg focus:outline-none">
                            {/* Wax Seal */}
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                                <svg
                                    className="overflow-visible w-44 h-44"
                                    width="800"
                                    height="800"
                                    viewBox="0 0 512 512"
                                    xmlns="http://www.w3.org/2000/svg"
